...
public class Ads {
    ...
    public static ArrayList<InterstitialAd> getInterstitialVideoItems(ArrayList<InterstitialAd> rvListItems) {
        ...
        rvListItems.add(InterstitialAd.from("ic_landing_7", "1127", R.drawable.tile_7, "video_7", "480", "320"));
        rvListItems.add(InterstitialAd.from("ic_landing_8", "1128", R.drawable.tile_8, "video_8", "480", "320"));
        return rvListItems;
    }
